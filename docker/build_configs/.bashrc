...
PS1='${debian_chroot:+($debian_chroot)}\[\033[00;34m\]sandbox\[\033[00;32m\]<\[\033[01;32m\]\t\[\033[00;32m\]>::\[\033[01;32m\]\u\[\033[00;32m\]("\[\033[01;32m\]\w/\[\033[00;32m\]");\e[0m\n\$ '
...
## quartus variables, in case license server, etc
source ~/.quartus-sys.env

## GUI IDEs will need the following when based on Qt
export QT_X11_NO_MITSHM=1

if [[ -z "$(echo $PATH | grep '/opt/intelFPGA/22.1pro/quartus/bin')" ]]; then
	export PATH=$PATH:/opt/intelFPGA/22.1pro/quartus/bin
fi
